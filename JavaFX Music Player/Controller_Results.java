...
public class Controller_Results
{
    ...
    public void initialize()
    {
        ...
        if(sc.dir_text.getText().isEmpty() != true)
        {
            ...
            for(MediaFile mf : DB_Manager.getInstance().getPlaylists())
            {
    ...
    {
        Stage stage = (Stage) browse_table.getScene().getWindow();
        stage.setScene(sc.browseScene);
    }
    private ObservableList<MediaFile> generateDummyData()
    {
        ...
        MediaFile n1 = new MediaFile("fur elise", "wmv", "C://", 0);
        MediaFile n2 = new MediaFile("Strobe", "wmv", "C://", 1);
        MediaFile n3 = new MediaFile("lalalala", "wmv", "C://", 2);
